...
from tokenTransfersDB import tokenTransfersDB
...
def main(contractaddress, sqlname, minsize):
    ...
    for i in data:
        ...
        if (float(stramount)) > float(minsize) and tokenTransfersDB.read(sqlname, str(txHash))==None:
            tokenTransfersDB.write(sqlname, txHash, time, send, rev, amount)
...
if __name__ == '__main__':
    ...
    try:
        ...
        tokenTransfersDB.create(sqlname)
    except Exception as e:
        print(e)
    else:
